# CLAUDE HANDOFF - DESIGN AND IMPLEMENTATION PLAN ONLY
# Give Claude this entire file. The full specification follows as comments.
# This is an inert GDScript container; do not attach it to a scene or autoload it.
# Proposed values require implementation and playtest validation.
extends RefCounted
